...
public class DayNightController : MonoBehaviour
{
	...
	/// <summary>
	/// The amount of time it takes for the background color to lerp to the next
	/// </summary>
	...
	private void UpdateDaylight()
	{
		if (currentPhase == DayPhase.Dawn)
		{
			...
			Camera.main.backgroundColor = Color.Lerp(fullDark, fullLight, relativeTime / quarterDay);
			if (GetComponent<Light>() != null)
		...
		else if (currentPhase == DayPhase.Dusk)
		{
			...
			Camera.main.backgroundColor = Color.Lerp(fullLight, fullDark, relativeTime / quarterDay);
			if (GetComponent<Light>() != null)
